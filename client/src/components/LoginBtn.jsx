...
const LoginBtn = () => {
  ...
  const handleLoginClick = async () => {
    ...
    console.log('spotclient: ' + clientId)
    console.log('spotUri: ' + redirectUri)
    const scope =
      'user-read-playback-position streaming user-read-playback-state user-read-private user-read-email user-modify-playback-state'
